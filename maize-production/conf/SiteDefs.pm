...
# $SiteDefs::ENSEMBL_PROXY_PORT = 80;   # Port used for self-referential URLs:
    ...
    $SiteDefs::ENSEMBL_SERVERNAME  = 'maizesequence.org';
    ...
    $SiteDefs::ENSEMBL_PRIMARY_SPECIES   = 'Zea_mays';     # Default species
    $SiteDefs::ENSEMBL_SECONDARY_SPECIES = 'Zea_mays2';    # Default species
    ...
    $SiteDefs::PerlSetVar{GrameneUrl}     = 'http://www.gramene.org';
