package Bio::EnsEMBL::GlyphSet::submittergeneannotation;
use strict;
use vars qw(@ISA);
use Carp qw(cluck);
use EnsWeb;
...
sub features {
  ...
  return $self->{'container'}->get_all_Genes('submittergeneannotation');	#lc(EnsWeb::species_defs->AUTHORITY));
}
