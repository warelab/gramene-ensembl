...
##weix experiment adding Variation tracks on top view -- weix
...
## end of experiment code by weix

  $self->load_tracks;

  $self->modify_configs([ 'transcript' ], { render => 'gene_label', strand => 'r' });
$self->modify_configs([ 'variation',  'variation_legend', 'structural_variation_legend' ], { display => 'normal' }); #weix
