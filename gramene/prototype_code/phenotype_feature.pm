...
sub features {
 ...
 warn ("debug weix === type=$type, region is ", $slice->seq_region_name, ":", $slice->seq_region_start, "-", $slice->seq_region_end, ":", $slice->strand, "\n");
        warn ("fetch_all_by_Slice_type got ", scalar @{$pf_adaptor->fetch_all_by_Slice_type($slice, $type)}, " phentoype features\n");
