...
#warn("DEBUG weix ExportImage.pm path1=$path\n");
  ## Strip double dots to prevent downloading of files outside tmp directory
  $path =~ s/\.\.//g;
  ## Remove any remaining illegal characters
  #$path =~ s/[^\w|-|\.|\/]//g;   #this altered filename and the server cannot find the file for user to download
#warn("DEBUG weix ExportImage.pm path2=$path\n");
  ## Get content
