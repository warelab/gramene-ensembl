...
sub _genebuild_text {
  ...
  if( $species =~ /Zea_mays/i ){  ###weix-start
        $im_url = "http://ftp.gramene.org/CURRENT_RELEASE/gff3/zea_mays/gene_id_mapping_v3_to_v4/";
  ...
  if( $species =~ /Zea_mays/i ){  ##weix-start
        my $func_url = "http://ftp.gramene.org/CURRENT_RELEASE/gff3/zea_mays/repeat_annotation/";
