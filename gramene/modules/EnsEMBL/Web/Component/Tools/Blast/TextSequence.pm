...
#warn ("in blast Textseq init component => $package[-1], type => $package[-2], cache => 1\n");
#component => GenomicSeq, type => Blast, cache => 1
...
#warn ("DEBUG before content_sub_slice self->initialize_new($slice, $start, $end)\n");
