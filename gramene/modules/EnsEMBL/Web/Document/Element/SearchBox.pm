...
# $Id: SearchBox.pm,v 1.15 2013-11-28 10:53:32 sb23 Exp $
      ...
      <form action="$search_url">
        <div class="search print_hide">
          <div>
            ...
            <input class="query inactive" style="border: 0; border-radius: 5px; background: #dde5e3; margin-right: 10px; font-size: 0.929em;" id="se_q" type="text" name="q" value="&nbsp;$options_hash{$search_code}{'label'}&hellip;" />
          </div>
