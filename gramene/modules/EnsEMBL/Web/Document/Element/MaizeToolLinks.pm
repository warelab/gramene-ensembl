...
# push @links, 'search',      '<a class="constant" href="http://maize-pangenome.gramene.org/">Gramene Search</a>';
#  return \@links;
#}
...
#  push @links, 'docs',          '<a class="constant" href="http://www.ensemblgenomes.org/info">Documentation</a>';
  push @links, 'feedback',      '<a class="constant" href="http://maize-pangenome.gramene.org/feedback">Feedback</a>';
push @links, 'search',      '<a class="constant" href="http://maize-pangenome.gramene.org/">Gramene Search</a>';
# test upload link
